...
/**
 * ProjectAttachment form base class.
 *
 * @method ProjectAttachment getObject() Returns the current form's model object
 *
 * @package    EasyGtd
 * @subpackage form
 ...
 */
abstract class BaseProjectAttachmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'ProjectAttachment', 'column' => array('normalized_value')))
    );

    $this->widgetSchema->setNameFormat('project_attachment[%s]');
