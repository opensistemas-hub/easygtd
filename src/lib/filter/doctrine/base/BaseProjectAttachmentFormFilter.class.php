...
/**
 * ProjectAttachment filter form base class.
 *
 * @package    EasyGtd
 * @subpackage filter
 ...
 */
abstract class BaseProjectAttachmentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('project_attachment_filters[%s]');
