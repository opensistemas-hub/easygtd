...
/**
 * ActionProject filter form base class.
 *
 * @package    EasyGtd
 * @subpackage filter
 ...
 */
abstract class BaseActionProjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('action_project_filters[%s]');
