...
/**
 * NextActionAttachment filter form base class.
 *
 * @package    EasyGtd
 * @subpackage filter
 ...
 */
abstract class BaseNextActionAttachmentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('next_action_attachment_filters[%s]');
