...
abstract class BaseProjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'brainstorming'    => new sfWidgetFormFilterInput(),
      'project_state_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ProjectState'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'project_state_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ProjectState'), 'column' => 'id')),
