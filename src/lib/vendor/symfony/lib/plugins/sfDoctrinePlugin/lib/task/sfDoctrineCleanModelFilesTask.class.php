...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    if ($modelsTodelete = array_diff($this->getFileModels($config['models_path']), $this->getYamlModels($config['yaml_schema_path'])))
    {
      ...
      $deleteModelFiles->run($modelsTodelete, array('no-confirmation' => $options['no-confirmation']));
